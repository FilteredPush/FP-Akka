...
public class NewScientificNameValidator extends UntypedActor {
    ...
    public NewScientificNameValidator(final boolean useCache, final boolean insertGUID, final int instances, final String authorityName, final boolean taxonomicMode, final ActorRef listener ) {
        ...
        workerRouter = getContext().actorOf(new RoundRobinPool(instances).props(ScientificNameValidatorInvocation.props(useCache, insertGUID, authorityName, taxonomicMode, listener)),
                "workerRouter");
...
class ScientificNameValidatorInvocation extends UntypedActor {
    ...
    public static Props props(final boolean useCache, final boolean insertGUID, final String authorityName, final boolean taxonomicMode, final ActorRef listener) {
        return Props.create(new Creator<ScientificNameValidatorInvocation>() {
